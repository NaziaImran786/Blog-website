...
export default function ContactForm() {
  ...
  return (
    <div className="min-h-screen bg-[#ffffff] flex items-center justify-center pt-20 pb-16 p-4">
        ...
        <div className="p-10 text-[#EEEEEE] lg:w-1/2">
          ...
          <div className="space-y-4 mb-16">
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm">naziaimran.4df@gmail.com</span>
            </div>
            <div className="flex items-center gap-3 bg-[rgba(87,10,87,0.5)] border border-[#A91079] p-4 rounded-lg">
              ...
              <span className="text-sm">+92 317 1234567</span>
            </div>
            <div className="flex items-center gap-3">
              ...
              <div className="space-y-6">
                <div className="space-y-1">
                  <Input
                    ...
                    className="border-0 border-b-2 px-1 border-[#A91079] rounded-none  focus-visible:ring-0"
                ...
                <div className="space-y-1">
                  <Input
                    ...
                    className="border-0 border-b-2 border-[rgba(46,2,73,0.3)] rounded-none px-1 focus-visible:ring-0"
                ...
                <div className="space-y-1">
                  <Textarea
                    ...
                    className="border-0 border-b-2 border-[rgba(46,2,73,0.3)] rounded-none px-1 focus-visible:ring-0 min-h-[100px] resize-none"
